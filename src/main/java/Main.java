...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //csvのload
        ListDataSource irisesSource = csvLoader.loadDataSource(Paths.get("src/bezdekIris.data"), "species", irisHeaders);
        System.out.println(irisesSource.size());//全体のサイズとしては150
